 ...
 */
exports.AiFormService = class AiFormService {
    constructor() {
    ...
    validate() {
        ...
        const errorMessage = formaiCore.validateValue(currentValue, currentConfig);
        this.error.set(errorMessage);
    }
};
exports.AiFormService = __decorate([
    core.Injectable(),
    __metadata("design:paramtypes", [])
], exports.AiFormService);
